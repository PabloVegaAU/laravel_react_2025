...
export default function LoginHistories({ login_histories, users, risk_levels, status_options, statistics, filters }: PageProps) {
  ...
  return (
    <AppLayout breadcrumbs={[{ title: 'Login Histories', href: '/admin/login-histories' }]}>
        ...
        {showFilters && (
          <div className='bg-muted/50 grid grid-cols-1 gap-4 rounded-lg p-4 md:grid-cols-3 lg:grid-cols-4'>
            <div>
              ...
              <Select value={localFilters.user_id || ''} onValueChange={(value) => handleFilterChange('user_id', value || undefined)}>
                <SelectTrigger>
            ...
            <div>
              ...
              <Select value={localFilters.risk_level || ''} onValueChange={(value) => handleFilterChange('risk_level', value || undefined)}>
                <SelectTrigger>
