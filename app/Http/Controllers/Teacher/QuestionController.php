...
class QuestionController extends Controller
{
    ...
    public function index()
    {
        ...
        $competencies = Competency::select('id', 'name', 'curricular_area_id')
            ->whereIn('curricular_area_id', $curricularAreas->pluck('id'))
            ->get();
        ...
        $questions = Question::select([
            ...
            ->with([
                ...
                'capability.competency:id,name,curricular_area_id',
                'capability.competency.curricularArea:id,name',
            ])
            ->latest('created_at')
            ->paginate(10);
