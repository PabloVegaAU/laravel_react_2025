...
Route::post('teacherstudentssearch', [ApiController::class, 'teacherstudentssearch']);
...
Route::post('getstudentbyachievementteacher', [ApiController::class, 'getstudentbyachievementteacher']);
