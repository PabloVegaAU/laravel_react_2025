  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "relative flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4 pb-96", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-4", children: [
        /* @__PURE__ */ jsx("div", { className: "bg-white dark:bg-sidebar p-2 rounded-xl", children: /* @__PURE__ */ jsx("h2", { className: "text-xl font-semibold", children: t("Pending Application Forms") }) }),
