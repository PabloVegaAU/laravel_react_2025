...
import { useState, useEffect, useCallback, memo, useMemo, Fragment as Fragment$1 } from "react";
import { Slot } from "@radix-ui/react-slot";
import { cva } from "class-variance-authority";
import { XIcon, PanelLeftIcon, ShoppingCart, Package, Gift, GraduationCap, ClipboardList, FileQuestion, Book, Users, Home, User, Image, Trophy, Settings, LogOut, ChevronsUpDown, ChevronRight } from "lucide-react";
import { c as cn } from "./utils-CpIjqAVa.js";
import { B as Button } from "./button-B8Z_lz_J.js";
import * as DialogPrimitive from "@radix-ui/react-dialog";
import { T as TooltipProvider, a as Tooltip, b as TooltipTrigger, c as TooltipContent, d as useMobileNavigation, u as useUserStore } from "./use-mobile-navigation-cG7zaCET.js";
import { usePage, Link, router } from "@inertiajs/react";
import { A as AppLogoIcon } from "./app-logo-icon-Dnok8BqH.js";
...
const createNavItems = (permissions = []) => {
  const noTitleNavItems = [
    {
      title: "Inicio",
      href: "/admin",
      icon: Home,
  ...
  const applicationFormsNavItems = [
    {
...
const AppLogo = memo(function AppLogo2() {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx("div", { className: "flex aspect-square size-12 items-center justify-center rounded-md", children: /* @__PURE__ */ jsx(AppLogoIcon, { className: "object-contain" }) }),
    /* @__PURE__ */ jsx("div", { className: "ml-1 grid flex-1 text-left text-sm", children: /* @__PURE__ */ jsx("span", { className: "mb-0.5 truncate leading-tight font-semibold", children: "JULIO C. TELLO" }) })
  ] });
});
...
function NavFooter({
  ...
  return /* @__PURE__ */ jsx(SidebarGroup, { ...props, className: `group-data-[collapsible=icon]:p-0 ${className || ""}`, children: /* @__PURE__ */ jsx(SidebarGroupContent, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, className: "text-neutral-600 hover:text-neutral-800 dark:text-neutral-300 dark:hover:text-neutral-100", children: /* @__PURE__ */ jsxs("a", { href: item.href, target: "_blank", rel: "noopener noreferrer", children: [
    item.icon && /* @__PURE__ */ jsx(Icon, { iconNode: item.icon, className: "h-5 w-5" }),
    /* @__PURE__ */ jsx("span", { children: item.title })
  ] }) }) }, item.title)) }) }) });
}
function NavMain({ title, items = [] }) {
  const page = usePage();
  return /* @__PURE__ */ jsxs(SidebarGroup, { className: "px-2 py-0", children: [
    title && /* @__PURE__ */ jsx(SidebarGroupLabel, { children: title }),
    /* @__PURE__ */ jsx(SidebarMenu, { children: items.map((item) => /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { asChild: true, isActive: item.href === page.url, tooltip: { children: item.title }, children: /* @__PURE__ */ jsxs(Link, { href: item.href, prefetch: true, children: [
...
function UserMenuContent({ user }) {
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(DropdownMenuSeparator, {}),
    /* @__PURE__ */ jsx(DropdownMenuItem, { asChild: true, children: /* @__PURE__ */ jsxs(Link, { className: "block w-full", method: "post", href: route("logout"), as: "button", onClick: handleLogout, children: [
...
function ProgressBar() {
  ...
  const progressQuery = useQuery({
    queryKey: ["progress", (_a = auth.user) == null ? void 0 : _a.id],
    queryFn: () => progressRes(),
    enabled: !!((_b = auth.user) == null ? void 0 : _b.id)
  ...
  const progressRes = async () => {
    ...
    const response = await fetch("/api/studentprogressbar", {
      method: "POST",
      body: JSON.stringify({ p_user_id: Number((_a2 = auth.user) == null ? void 0 : _a2.id) }),
      headers: { "Content-Type": "application/json" }
    });
    const data = await response.json();
    if (data.success && ((_b2 = data.data) == null ? void 0 : _b2.length) > 0) {
  ...
  if (progressQuery.isLoading) {
    return /* @__PURE__ */ jsx("div", { children: "Loading progress..." });
  }
  if (progressQuery.isError) {
    return /* @__PURE__ */ jsx("div", { children: "Error loading progress." });
  }
  ...
  const bgColorClass = progressColorClass.includes("red") ? "bg-red-50 border-red-300" : progressColorClass.includes("orange") ? "bg-orange-50 border-orange-300" : progressColorClass.includes("yellow") ? "bg-yellow-50 border-yellow-300" : progressColorClass.includes("blue") ? "bg-blue-50 border-blue-300" : "bg-green-50 border-green-300";
  const textColorClass = progressColorClass.includes("red") ? "text-red-700" : progressColorClass.includes("orange") ? "text-orange-700" : progressColorClass.includes("yellow") ? "text-yellow-700" : progressColorClass.includes("blue") ? "text-blue-700" : "text-green-700";
  const badgeBgClass = progressColorClass.includes("red") ? "bg-red-200 text-red-900" : progressColorClass.includes("orange") ? "bg-orange-200 text-orange-900" : progressColorClass.includes("yellow") ? "bg-yellow-200 text-yellow-900" : progressColorClass.includes("blue") ? "bg-blue-200 text-blue-900" : "bg-green-200 text-green-900";
  return /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxs("div", { className: `rounded-xl border p-4 shadow-sm ${bgColorClass}`, children: [
    /* @__PURE__ */ jsx("div", { className: "mb-1 text-sm font-medium text-gray-600", children: "Nivel actual" }),
    /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx("div", { className: `text-3xl font-bold ${textColorClass}`, children: progress.nivel_actual }),
      /* @__PURE__ */ jsxs("span", { className: `rounded-full px-3 py-1 text-xs font-semibold ${badgeBgClass}`, children: [
        progress.progress_percent,
        "% completado"
      ] })
    ] }),
    /* @__PURE__ */ jsx("div", { className: "mb-2 h-3 w-full overflow-hidden rounded-full bg-gray-200", children: /* @__PURE__ */ jsx(
      "div",
      {
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-gray-600", children: [
      /* @__PURE__ */ jsxs("span", { children: [
        "XP: ",
        Number(progress.experience_achieved).toFixed(0)
      ] }),
      /* @__PURE__ */ jsxs("span", { children: [
        "Máx: ",
        Number(progress.experience_max).toFixed(0)
      ] })
    ] })
  ] }) });
}
...
function AppSidebar() {
  ...
  const navigationSections = useMemo(
    ...
    [permissions]
    // Solo se recrea cuando los permisos cambian
  );
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: currentDashboardRole, children: /* @__PURE__ */ jsx(AppLogo, {}) }) }) }) }) }),
    /* @__PURE__ */ jsxs(SidebarContent, { children: [
      showStudentSection && /* @__PURE__ */ jsx(StudentProfileSection, { state, avatar, userName: (_a = auth.user) == null ? void 0 : _a.name, getInitials }),
      /* @__PURE__ */ jsx(
        NavigationSections,
        {
          noTitleNavItems,
    ...
    !showStudentSection && /* @__PURE__ */ jsxs(SidebarFooter, { children: [
      /* @__PURE__ */ jsx(NavFooter, { items: FOOTER_NAV_ITEMS, className: "mt-auto" }),
      /* @__PURE__ */ jsx(NavUser, {})
    ] })
  ] });
}
function StudentProfileSection({ state, avatar, userName, getInitials }) {
  const isCollapsed = state === "collapsed";
  return /* @__PURE__ */ jsxs(Link, { href: "/student/profile", className: "flex flex-col items-center gap-4 p-4", children: [
    /* @__PURE__ */ jsxs(Avatar, { className: isCollapsed ? "size-12" : "size-20", children: [
      /* @__PURE__ */ jsx(AvatarImage, { src: avatar || void 0, alt: userName || void 0 }),
      /* @__PURE__ */ jsx(AvatarFallback, { className: "bg-green-200 text-green-900", children: getInitials(userName || "") })
    ] }),
    !isCollapsed && /* @__PURE__ */ jsx("div", { children: /* @__PURE__ */ jsx(ProgressBar, {}) })
  ] });
}
function NavigationSections({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(NavMain, { items: noTitleNavItems }),
    showPeopleSection && /* @__PURE__ */ jsx(NavMain, { title: "PERSONAS", items: peopleNavItems }),
    showSchoolSection && /* @__PURE__ */ jsx(NavMain, { title: "COLEGIO", items: schoolNavItems }),
    showApplicationFormsSection && /* @__PURE__ */ jsx(NavMain, { title: "FICHAS DE APLICACIÓN", items: applicationFormsNavItems }),
    showStoreSection && /* @__PURE__ */ jsx(NavMain, { title: "TIENDA DE PUNTOS", items: storeNavItems })
  ] });
}
...
function AppSidebarLayout({ children, breadcrumbs = [] }) {
  return /* @__PURE__ */ jsxs(AppShell, { variant: "sidebar", children: [
    ...
    /* @__PURE__ */ jsxs(AppContent, { variant: "sidebar", className: "overflow-x-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-20 min-h-screen", children: [
