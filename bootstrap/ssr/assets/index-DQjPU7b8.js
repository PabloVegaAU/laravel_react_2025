...
import { CreateBackgroundModal } from "./create-background-modal-DL5zIeiw.js";
import { EditBackgroundModal } from "./edit-background-modal-DJ55D1_l.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "container mx-auto p-6", children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "dark:border-sidebar-border dark:bg-sidebar rounded-lg border border-gray-200 bg-white", children: /* @__PURE__ */ jsxs(Table, { children: [
        ...
        /* @__PURE__ */ jsx(TableBody, { children: filteredBackgrounds.map((background, index) => /* @__PURE__ */ jsxs(TableRow, { children: [
          ...
          /* @__PURE__ */ jsx(TableCell, { children: background.activo ? /* @__PURE__ */ jsx("span", { className: "rounded-full bg-green-100 px-2 py-1 text-xs text-green-800 dark:bg-green-900/30 dark:text-green-400", children: "Activo" }) : /* @__PURE__ */ jsx("span", { className: "rounded-full bg-red-100 px-2 py-1 text-xs text-red-800 dark:bg-red-900/30 dark:text-red-400", children: "Inactivo" }) }),
