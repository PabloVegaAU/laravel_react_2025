...
import { D as Dialog, a as DialogContent, b as DialogHeader, c as DialogTitle, d as DialogFooter } from "./dialog-7YW305Sc.js";
...
function CreatePrizeModal({ isOpen, onClose, onSuccess }) {
  ...
  const onSubmit = async (e) => {
    ...
    try {
      ...
      if (data.level_required) {
        ...
        formData.append("required_level_id", String(data.level_required));
      }
      ...
      if (!response.ok) {
        if (responseData.errors) {
          Object.values(responseData.errors).flat().forEach((err) => toast.error(String(err)));
          return;
        }
  ...
  return /* @__PURE__ */ jsx(Dialog, { open: isOpen, onOpenChange: (open) => !open && onClose(), children: /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-[500px]", children: [
    /* @__PURE__ */ jsx(DialogHeader, { children: /* @__PURE__ */ jsx(DialogTitle, { children: "Crear Premio" }) }),
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
        ...
        /* @__PURE__ */ jsxs(
          "select",
          {
            ...
            children: [
              /* @__PURE__ */ jsx("option", { value: "", children: "Ninguno (Disponible para todos)" }),
