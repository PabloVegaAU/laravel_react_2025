...
function CreateStudentDialog({ isOpen, onOpenChange }) {
  const initialValues = {
    /* USER */
    name: "",
    password: "",
  ...
  return /* @__PURE__ */ jsxs(Dialog, { open: isOpen, onOpenChange, children: [
    /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "outline-info", children: "Agregar estudiante" }) }),
    /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-[700px]", children: [
      /* @__PURE__ */ jsx(DialogTitle, { children: "Agregar estudiante" }),
      /* @__PURE__ */ jsx(DialogDescription, { children: "Complete el formulario para agregar un nuevo estudiante." }),
