...
function Dashboard() {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsxs("header", { className: "mb-4 flex flex-col items-start justify-between gap-4 p-6 sm:flex-row sm:items-center sm:gap-0 lg:p-8", children: [
      /* @__PURE__ */ jsx("div", { className: "border-border dark:bg-muted mb-8 rounded-lg border bg-white p-6", children: /* @__PURE__ */ jsx("strong", { className: "text-foreground text-2xl font-bold sm:text-3xl lg:text-4xl xl:text-5xl", children: "TIENDA DE PUNTOS" }) }),
      /* @__PURE__ */ jsx("div", { className: "rounded-xl border border-yellow-200 bg-yellow-50 px-4 py-3 sm:px-6 sm:py-4 dark:border-yellow-800 dark:bg-yellow-950", children: /* @__PURE__ */ jsxs("span", { className: "text-lg font-medium text-yellow-900 sm:text-xl lg:text-2xl xl:text-3xl dark:text-yellow-100", children: [
        "Tus puntos: ",
