...
import { QuestionResponse } from "./QuestionResponse-DDY5H7Sg.js";
import "sonner";
import "clsx";
...
import "./SingleChoiceResponse-7wahY3Va.js";
      ...
      /* @__PURE__ */ jsx("div", { className: "space-y-8", children: application_form_response.response_questions.map((responseQuestion, index) => {
        ...
        return /* @__PURE__ */ jsxs(Card, { children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "flex flex-col-reverse gap-4 md:flex-row md:items-center", children: [
            ...
            image && /* @__PURE__ */ jsx("div", { className: "w-full md:h-full md:w-auto", children: /* @__PURE__ */ jsx(Image, { src: image, alt: image, className: "w-full" }) })
          ] })
        ] }, responseQuestion.id);
      }) })
    ] }) }) })
