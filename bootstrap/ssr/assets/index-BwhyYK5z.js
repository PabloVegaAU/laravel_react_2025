...
import { g as getQuestionTypeBadge, Q as QUESTION_TYPES } from "./question-type-c-DbkR_Yi5.js";
...
function QuestionDisplay({
          ...
          /* @__PURE__ */ jsx("ul", { className: "space-y-1", children: options.map((option) => /* @__PURE__ */ jsxs(
            "li",
            {
              ...
              children: [
                ...
                /* @__PURE__ */ jsx("span", { children: option.value ?? t("No value") })
              ]
            },
            option.id
          )) })
        ...
        return /* @__PURE__ */ jsxs("div", { className: "mt-3 space-y-3", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "space-y-2", children: leftItems.map((left) => {
            ...
            return /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2 text-sm", children: [
              /* @__PURE__ */ jsx("span", { className: "font-medium", children: left.value ?? t("No value") }),
              /* @__PURE__ */ jsx(Link$1, { className: "text-muted-foreground h-4 w-4 flex-shrink-0" }),
              /* @__PURE__ */ jsx("span", { className: "truncate", children: (rightMatch == null ? void 0 : rightMatch.value) ?? t("No match") })
            ] }, left.id);
          }) })
        ] });
      case QUESTION_TYPES.TRUE_FALSE: {
        ...
        return /* @__PURE__ */ jsxs("div", { className: "mt-3 space-y-2", children: [
          ...
          /* @__PURE__ */ jsx("div", { className: "flex items-center gap-2", children: isTrueCorrect ? /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-green-600", children: [
            ...
            /* @__PURE__ */ jsx("span", { children: t("True") })
          ] }) : /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-1 text-red-600", children: [
            /* @__PURE__ */ jsx(XCircle, { className: "h-4 w-4" }),
            /* @__PURE__ */ jsx("span", { children: t("False") })
          ] }) })
        ] });
      }
      case QUESTION_TYPES.OPEN_ANSWER:
        return /* @__PURE__ */ jsx("div", { className: "mt-3 space-y-2", children: /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Explanation required") }) });
      default:
  ...
  return /* @__PURE__ */ jsx("div", { className: cn("rounded-lg border border-s-4 p-4", borderColor), children: /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-wrap items-center gap-2 pt-1", children: [
      ...
      q.explanation_required && /* @__PURE__ */ jsx("span", { className: "inline-flex items-center rounded-full bg-gray-100 px-2.5 py-0.5 text-xs font-medium text-gray-800", children: t("Explanation required") }),
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-col-reverse flex-wrap items-center justify-between gap-2 pt-1 md:flex-row", children: [
      renderOptions(),
      q.image && /* @__PURE__ */ jsx(Image, { src: q.image, alt: q.name, className: "w-64" })
    ] })
  ] }) });
}
    ...
    /* @__PURE__ */ jsx("div", { className: "flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
      /* @__PURE__ */ jsxs("div", { className: "flex items-center justify-between", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
          ...
          /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", size: "sm", children: /* @__PURE__ */ jsx(Link, { href: route("teacher.application-forms.edit", application_form.id), children: t("Edit form") }) })
        ] })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "grid gap-6 md:grid-cols-2", children: [
        /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: t("General Information") }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Curricular Area") }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Competency") }),
              /* @__PURE__ */ jsx("div", { children: ((_f = (_e = application_form.learning_session) == null ? void 0 : _e.competency) == null ? void 0 : _f.name) || t("Not specified") })
            ] }),
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Grade/Section") }),
        ...
        /* @__PURE__ */ jsxs(Card, { children: [
          /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: t("Application Period") }) }),
          /* @__PURE__ */ jsxs(CardContent, { className: "space-y-4", children: [
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Start Date") }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("End Date") }),
            ...
            /* @__PURE__ */ jsxs("div", { className: "space-y-2", children: [
              /* @__PURE__ */ jsx("div", { className: "text-muted-foreground text-sm font-medium", children: t("Total Score") }),
              /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-2", children: [
                /* @__PURE__ */ jsx("span", { className: "text-lg font-bold", children: application_form.score_max }),
                /* @__PURE__ */ jsx("span", { className: "text-muted-foreground text-sm", children: t("points") })
              ] })
            ] })
          ] })
        ] })
      ...
      ((_p = application_form.learning_session) == null ? void 0 : _p.capabilities) && application_form.learning_session.capabilities.length > 0 && /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsx(CardHeader, { children: /* @__PURE__ */ jsx(CardTitle, { children: t("Capabilities") }) }),
      ...
      /* @__PURE__ */ jsxs(Card, { children: [
        /* @__PURE__ */ jsxs(CardHeader, { children: [
          /* @__PURE__ */ jsx(CardTitle, { children: t("Questions") }),
          /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground text-sm", children: [
            ((_q = application_form.questions) == null ? void 0 : _q.length) || 0,
            " ",
            t("questions in total")
          ] })
        ] }),
        /* @__PURE__ */ jsx(CardContent, { children: application_form.questions && application_form.questions.length > 0 ? /* @__PURE__ */ jsx("div", { className: "space-y-6", children: application_form.questions.map((question, index) => /* @__PURE__ */ jsx(QuestionDisplay, { question, index }, question.id)) }) : /* @__PURE__ */ jsx("div", { className: "rounded-lg border-2 border-dashed p-8 text-center", children: /* @__PURE__ */ jsx("p", { className: "text-muted-foreground", children: t("No questions in this form") }) }) })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsx(Button, { asChild: true, variant: "outline", children: /* @__PURE__ */ jsx(Link, { href: route("teacher.application-forms.index"), children: t("Back to list") }) }) })
    ] }) })
  ] });
}
export {
