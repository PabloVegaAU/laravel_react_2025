...
import { H as HeadingSmall, S as SettingsLayout } from "./layout-BEDVmWm8.js";
import { D as Dialog, a as DialogTrigger, b as DialogContent, d as DialogTitle, e as DialogDescription, f as DialogFooter, g as DialogClose } from "./dialog-sRXsDe1Q.js";
...
function Profile({ mustVerifyEmail, status }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: t("Profile settings") }),
    /* @__PURE__ */ jsxs(SettingsLayout, { children: [
      /* @__PURE__ */ jsxs("div", { className: "space-y-6", children: [
        /* @__PURE__ */ jsx(HeadingSmall, { title: t("Profile information"), description: t("Update your name and email address") }),
        /* @__PURE__ */ jsxs("form", { onSubmit: submit, className: "space-y-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "grid gap-2", children: [
            /* @__PURE__ */ jsx(Label, { htmlFor: "email", children: t("Email address") }),
            /* @__PURE__ */ jsx(
              Input,
              {
                id: "email",
            ...
            /* @__PURE__ */ jsxs("p", { className: "text-muted-foreground -mt-4 text-sm", children: [
              ...
              /* @__PURE__ */ jsx(
                Link,
                {
                  ...
                  children: t("Click here to resend the verification email.")
                }
              )
            ] }),
            status === "verification-link-sent" && /* @__PURE__ */ jsx("div", { className: "mt-2 text-sm font-medium text-green-600", children: t("A new verification link has been sent to your email address.") })
          ] }),
          /* @__PURE__ */ jsxs("div", { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsx(Button, { disabled: processing, children: t("Save") }),
            /* @__PURE__ */ jsx(
              Transition,
              {
