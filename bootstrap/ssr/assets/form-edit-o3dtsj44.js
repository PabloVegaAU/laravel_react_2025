...
import { D as Dialog, e as DialogTrigger, a as DialogContent, c as DialogTitle, f as DialogDescription } from "./dialog-7YW305Sc.js";
import { I as Input } from "./input-Dr5dPtfm.js";
import { L as Label } from "./label-GjpnCFkz.js";
import { a as formatDateForInput } from "./formats-CLP1uR7X.js";
...
function EditStudentDialog({ userId }) {
  ...
  const { data, setData, put, processing, errors, reset } = useForm({
    ...
    entryDate: ((_f = user == null ? void 0 : user.student) == null ? void 0 : _f.entry_date) ?? ""
  });
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    if (user) {
      setData({
        ...
        entryDate: ((_f2 = user.student) == null ? void 0 : _f2.entry_date) ?? ""
      });
    }
  }, [user]);
  ...
  return /* @__PURE__ */ jsxs(
    Dialog,
    {
      ...
      children: [
        /* @__PURE__ */ jsx(DialogTrigger, { asChild: true, children: /* @__PURE__ */ jsx(Button, { variant: "outline-info", children: /* @__PURE__ */ jsx(PencilIcon, { className: "size-4" }) }) }),
        user && isOpen && !isLoading && /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-[700px]", children: [
          ...
          /* @__PURE__ */ jsx(DialogDescription, { children: "Complete el formulario para editar un estudiante." }),
          /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-6", children: [
            ...
            /* @__PURE__ */ jsxs("div", { className: "flex flex-col gap-2", children: [
              /* @__PURE__ */ jsx(Label, { htmlFor: "entryDate", children: "Fecha de ingreso" }),
              /* @__PURE__ */ jsx(Input, { id: "entryDate", name: "entryDate", type: "date", value: data.entryDate, onChange: (e) => setData("entryDate", e.target.value) }),
              /* @__PURE__ */ jsx(InputError, { message: errors.entryDate })
            ] }),
