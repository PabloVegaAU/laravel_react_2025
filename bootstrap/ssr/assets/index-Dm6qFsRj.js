...
function ApplicationsForm({ learning_session, teacher_classroom_curricular_area_cycle, questions }) {
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: "Crear Ficha de Aplicación" }),
    ...
    /* @__PURE__ */ jsx("div", { className: "flex h-full flex-1 flex-col gap-6 overflow-x-auto rounded-xl p-6", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
        ...
        /* @__PURE__ */ jsx("div", { className: "space-y-4", children: (_g = learning_session == null ? void 0 : learning_session.capabilities) == null ? void 0 : _g.map((capability) => /* @__PURE__ */ jsx("div", { className: cn("rounded-lg p-2", "bg-" + capability.color + "-500"), children: /* @__PURE__ */ jsx("span", { children: capability.name }) }, capability.id)) })
      ] }),
      /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
