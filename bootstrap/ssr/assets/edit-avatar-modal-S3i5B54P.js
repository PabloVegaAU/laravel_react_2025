...
function EditAvatarModal({ isOpen, onClose, avatar: initialAvatar, onSuccess }) {
  ...
  const onSubmit = async (e) => {
    ...
    formData.append("level_required", (_a = data == null ? void 0 : data.level_required) == null ? void 0 : _a.toString());
    ...
    router.post(`/admin/avatars/${avatar.id}`, formData, {
      ...
      onSuccess: (response) => {
        const avatarData = response.props.avatar || response;
        const updatedAvatar = {
          ...avatar,
          id: (avatarData == null ? void 0 : avatarData.id) ?? avatar.id,
          name: (avatarData == null ? void 0 : avatarData.name) ?? avatar.name,
          price: (avatarData == null ? void 0 : avatarData.price) ?? avatar.price,
          is_active: (avatarData == null ? void 0 : avatarData.is_active) ?? avatar.is_active ?? true,
          image_url: (avatarData == null ? void 0 : avatarData.image_url) ?? avatar.image_url,
          level_required: (avatarData == null ? void 0 : avatarData.level_required) ?? avatar.level_required,
