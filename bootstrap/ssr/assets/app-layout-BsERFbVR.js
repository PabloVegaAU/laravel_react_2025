...
import { XIcon, PanelLeftIcon, FileQuestion, GraduationCap, Book, Users, Home, Settings, LogOut, ChevronsUpDown, ChevronRight } from "lucide-react";
...
import { A as AppLogoIcon } from "./app-logo-icon-ZHVQJC4L.js";
...
function AppSidebar() {
  ...
  const navigationSections = createNavItems(permissions);
  ...
  return /* @__PURE__ */ jsxs(Sidebar, { collapsible: "icon", variant: "inset", children: [
    /* @__PURE__ */ jsx(SidebarHeader, { children: /* @__PURE__ */ jsx(SidebarMenu, { children: /* @__PURE__ */ jsx(SidebarMenuItem, { children: /* @__PURE__ */ jsx(SidebarMenuButton, { size: "lg", asChild: true, children: /* @__PURE__ */ jsx(Link, { href: currentDashboardRole, prefetch: true, children: /* @__PURE__ */ jsx(AppLogo, {}) }) }) }) }) }),
...
function StudentProfileSection({ state, avatar, userName, getInitials }) {
  ...
  return /* @__PURE__ */ jsxs(Link, { href: "/student/profile", prefetch: true, className: "flex flex-col items-center gap-4 p-4", children: [
...
function AppSidebarLayout({ children, breadcrumbs = [] }) {
  return /* @__PURE__ */ jsxs(AppShell, { variant: "sidebar", children: [
    ...
    /* @__PURE__ */ jsxs(AppContent, { variant: "sidebar", className: "overflow-x-hidden", children: [
      ...
      /* @__PURE__ */ jsxs("div", { className: "relative z-20 max-h-screen", children: [
