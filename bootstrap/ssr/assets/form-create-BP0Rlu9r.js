...
import { c as cn, n as normalizeString } from "./utils-CpIjqAVa.js";
import { S as Select, a as SelectTrigger, b as SelectValue, c as SelectItem, d as SelectContent } from "./select-DMPk8oWi.js";
...
function CreateEnrollmentDialog({ isOpen, onOpenChange }) {
  ...
  const initialValues = {
    ...
    enrollment_date: formatDateForInput(/* @__PURE__ */ new Date()),
    student_id: 0,
    classroom_id: 0,
    status: "active",
  ...
  return /* @__PURE__ */ jsxs(Dialog, { open: isOpen, onOpenChange, children: [
    ...
    /* @__PURE__ */ jsxs(DialogContent, { className: "sm:max-w-[700px]", children: [
      ...
      /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "flex flex-col gap-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-2 gap-4", children: [
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Checkbox, { checked: data.status === "active", onCheckedChange: (checked) => setData("status", checked ? "active" : "inactive") }),
            /* @__PURE__ */ jsx(Label, { children: "Activo" })
          ] }),
          /* @__PURE__ */ jsxs("div", { children: [
            /* @__PURE__ */ jsx(Label, { children: "Estado anterior" }),
            /* @__PURE__ */ jsxs(Select, { value: data.status_previous, onValueChange: (value) => setData("status_previous", value), children: [
              /* @__PURE__ */ jsx(SelectTrigger, { children: /* @__PURE__ */ jsx(SelectValue, { placeholder: "Seleccionar estado" }) }),
              /* @__PURE__ */ jsxs(SelectContent, { children: [
                /* @__PURE__ */ jsx(SelectItem, { value: "completed", children: "Completado" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "transferred", children: "Transferido" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "withdrawn", children: "Retirado" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "dismissed", children: "Expulsado" }),
                /* @__PURE__ */ jsx(SelectItem, { value: "failed", children: "Reprobado" })
              ] })
            ] }),
            /* @__PURE__ */ jsx(InputError, { message: errors.status_previous })
          ] })
        ] }),
