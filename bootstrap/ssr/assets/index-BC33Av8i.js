...
function ApplicationFormResponse({ application_form_responses, filters = {} }) {
  ...
  const columns = [
    ...
    },
    {
      ...
      cell: ({ row }) => {
        ...
        return action ? /* @__PURE__ */ jsx("div", { className: "flex space-x-2", children: /* @__PURE__ */ jsx(Link, { href: route(`teacher.application-form-responses.${action.route}`, id), className: "text-indigo-600 hover:text-indigo-900", children: action.label }) }) : null;
      }
    }
  ];
  const breadcrumbs = [
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    /* @__PURE__ */ jsx(Head, { title: t("Application Form Responses") }),
