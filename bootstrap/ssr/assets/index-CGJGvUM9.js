        ...
        return /* @__PURE__ */ jsxs(Card, { className: "overflow-hidden", children: [
          ...
          /* @__PURE__ */ jsxs(CardContent, { className: "flex items-center gap-4", children: [
            /* @__PURE__ */ jsx("div", { className: "flex-1 space-y-4 p-6", children: /* @__PURE__ */ jsxs("div", { className: "space-y-4", children: [
              (responseQuestion == null ? void 0 : responseQuestion.explanation) && /* @__PURE__ */ jsxs("div", { children: [
                /* @__PURE__ */ jsx(Label, { children: "Explicación:" }),
                /* @__PURE__ */ jsx("p", { className: "text-muted-foreground text-sm", children: responseQuestion == null ? void 0 : responseQuestion.explanation })
              ] }),
              questionTypeId !== 5 && /* @__PURE__ */ jsxs("div", { children: [
