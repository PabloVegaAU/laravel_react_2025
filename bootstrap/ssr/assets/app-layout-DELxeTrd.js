...
import { XIcon, PanelLeftIcon, ShoppingCart, Package, Trophy, GraduationCap, ClipboardList, FileQuestion, Book, Users, Home, User, Image, Gift, Settings, LogOut, ChevronsUpDown, ChevronRight } from "lucide-react";
...
function ProgressBar() {
  ...
  return /* @__PURE__ */ jsx("div", { className: "flex-1", children: /* @__PURE__ */ jsxs("div", { className: "rounded-xl border border-green-300 bg-green-50 p-4 shadow-sm", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "mb-2 flex items-center space-x-2", children: [
      /* @__PURE__ */ jsx("div", { className: "text-3xl font-bold text-green-700", children: progress.nivel_actual }),
      /* @__PURE__ */ jsxs("span", { className: "rounded-full bg-green-200 px-3 py-1 text-xs font-semibold text-green-900", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex justify-between text-xs text-gray-600", children: [
      ...
      /* @__PURE__ */ jsxs("span", { children: [
        "Objetivo: ",
        Number(progress.experience_required).toFixed(0)
      ] }),
      /* @__PURE__ */ jsxs("span", { children: [
        "Máx: ",
