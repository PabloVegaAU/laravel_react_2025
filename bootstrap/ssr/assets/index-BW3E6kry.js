...
import { M as MultiSelect, S as Switch } from "./switch-BG6mV6_k.js";
import { B as Button } from "./button-BqjjxT-O.js";
import { P as Popover, a as PopoverTrigger, b as PopoverContent, C as Calendar } from "./popover-DVAkeKRI.js";
...
function LearningSessionEdit({ learning_session, teacher_classroom_curricular_area_cycles }) {
  ...
  const { data, setData, put, processing, errors } = useForm({
    ...
    application_form_ids: ((_b = learning_session == null ? void 0 : learning_session.application_form) == null ? void 0 : _b.id.toString()) || [],
  ...
  useEffect(() => {
    ...
    if (learning_session) {
      setData({
        ...
        application_form_ids: ((_e = (_d = learning_session.application_form) == null ? void 0 : _d.id) == null ? void 0 : _e.toString()) || []
      });
  ...
  return /* @__PURE__ */ jsxs(AppLayout, { breadcrumbs, children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "flex h-full flex-1 flex-col gap-4 overflow-x-auto rounded-xl p-4", children: /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, className: "space-y-6", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "grid grid-cols-8 items-center gap-6", children: [
          ...
          /* @__PURE__ */ jsxs("div", { className: "col-span-6 w-full space-y-2", children: [
            ...
            /* @__PURE__ */ jsxs("div", { children: [
              ...
              /* @__PURE__ */ jsxs("div", { className: cn("flex items-center space-x-2", data.application_form_ids.length > 0 ? "hidden" : ""), children: [
      ...
      /* @__PURE__ */ jsx("div", { className: "flex items-center justify-center", children: /* @__PURE__ */ jsxs(Button, { type: "submit", disabled: processing, children: [
